...
def _row_from_summary(path: Path, data: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "abstain_precision": retrieval.get("abstain_precision"),
        "abstain_recall": retrieval.get("abstain_recall"),
        "abstain_rate": retrieval.get("abstain_rate"),
        "gold_missing_rate": retrieval.get("gold_missing_rate"),
