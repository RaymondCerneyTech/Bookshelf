...
Dense result (kv, k=4, s3q16): gold_present_rate 1.0000, selection_rate 1.0000, accuracy_when_gold_present 1.0000, value_acc 1.0000.
This shows even a cheap dense hash retriever can surface gold reliably in kv; the remaining bottleneck is selection/authority under ambiguity, not retrieval.
